...
const SketchButton = ({
  ...
  const drawFrame = useCallback((rc, ctx, canvas, frameIndex) => {
    ...
    if (isLoading) {
      ...
      const startAngle = (frameIndex / 6) * Math.PI * 2;
  ...
  }, [isHovered, color, stroke, strokeWidth, text, isLoading]);

  useSketchFrameCache(canvasRef, drawFrame, [dimensions, color, stroke, strokeWidth, text, fps, isHovered, isLoading], { fps });
